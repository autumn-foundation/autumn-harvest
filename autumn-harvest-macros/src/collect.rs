//! `workflows![]`, `activities![]`, `dags![]`, `queries![]`, `updates![]`,
//! `signals![]`, and `webhooks![]` bang macro implementations.
//!
//! These collect companion functions (generated by `#[workflow]`, `#[activity]`,
//! `#[query]`, `#[update]`, `#[signal]`, `#[webhook]`) into the corresponding
//! `Vec<*Info>` type.
