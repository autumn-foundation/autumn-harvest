...
///
/// Returns an array of [`RegisteredWorkflowRecord`](autumn_harvest::info::RegisteredWorkflowRecord) objects sorted by name.
...
///
/// Returns `200` with the [`RegisteredWorkflowRecord`](autumn_harvest::info::RegisteredWorkflowRecord) when the workflow is
