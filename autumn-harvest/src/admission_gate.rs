...
//! [`crate::admission_gate::GateCreateError::TooManyGates`] rather than silently
//! accepting the gate.
...
///
/// Reaching this limit returns [`crate::admission_gate::GateCreateError::TooManyGates`] rather than
