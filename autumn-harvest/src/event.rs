...
pub enum WorkflowEvent {
    ...
    ///
    /// The same superseded cycle can leave other pre-terminal records behind
    /// its last dispatch — a marker, a side effect, a detached spawn, a timer
    /// arm or cancel. [`crate::replay::HistoryMatcher::superseded_cycle_tail_indices`]
    /// marks those transparent too (issue #1262), so a re-issued dispatch
