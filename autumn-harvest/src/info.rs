...
///
/// Takes serialised JSON input and returns serialised JSON output or an error
/// string. Query handlers are synchronous — they inspect immutable state
/// without performing I/O.
pub type QueryHandlerFn = fn(serde_json::Value) -> Result<serde_json::Value, String>;

/// Type-erased async update handler for declarative `#[update]` functions.
///
/// Takes serialised JSON input and returns a future that resolves to the
/// serialised JSON output or an error string.
