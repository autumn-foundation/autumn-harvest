...
impl WorkflowContext {
    ...
    /// `register_and_dispatch_signal_handler`):
    ...
    /// Like [`for_replay_strict_with_state`](Self::for_replay_strict_with_state) but also sets `canary_mode` to `true`.
    #[must_use]
    ...
    /// Execute an activity using its [`ActivityInfo`](crate::info::ActivityInfo) for name, queue, and defaults.
    ///
    ...
    /// Execute a local activity inline on the workflow worker using its [`ActivityInfo`](crate::info::ActivityInfo).
    ///
    ...
    /// Spawn a child workflow and await its result using a [`WorkflowInfo`](crate::info::WorkflowInfo).
    ///
    /// This is the typed alternative to
    ...
    /// Register a declarative query handler from a [`QueryHandlerInfo`](crate::info::QueryHandlerInfo) companion record.
    ///
    ...
    /// Register a declarative update handler from an [`UpdateHandlerInfo`](crate::info::UpdateHandlerInfo) companion record.
    ///
    ...
    /// see `register_and_dispatch_signal_handler`'s
