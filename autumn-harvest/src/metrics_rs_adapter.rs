...
use crate::telemetry::{
    ...
    METRIC_LABEL_SLOT_TYPE, METRIC_LABEL_STATUS, METRIC_LABEL_TRIGGER, METRIC_LABEL_WORKFLOW,
    METRIC_LABEL_WORKFLOW_TYPE, METRIC_PAYLOAD_OFFLOAD_FETCH_DURATION, METRIC_PAYLOAD_OFFLOADED,
    ...
    METRIC_WORKER_SLOTS_AVAILABLE, METRIC_WORKER_SLOTS_IN_USE, METRIC_WORKFLOW_CACHE_HIT,
